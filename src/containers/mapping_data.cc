...
//    ss << "--- [" << i << "] ";
    ...
    ss << ", sam_NM = " << mapping_data->at(i)->get_alignment_primary().edit_distance << ", sam_AS = " << mapping_data->at(i)->get_alignment_primary().alignment_score << ", sam_pos = " << mapping_data->at(i)->get_alignment_primary().pos_start << ", sam_mapq = " << ((int64_t) mapping_data->at(i)->get_alignment_primary().mapping_quality) << ", relative_position = " << relative_position;
    ss << "\n      ° l1_l = " << mapping_data->at(i)->get_l1_data().l1_l << ", match_rate = " << ((float) mapping_data->at(i)->get_alignment_primary().num_eq_ops) / ((float) read->get_sequence_length());
