...
int ProcessArgs(int argc, char **argv, ProgramParameters *parameters)
{
  ...
  argparser.AddArgument(&parameters->output_in_original_order, VALUE_TYPE_BOOL, "u", "ordered", "", "SAM alignments will be output after the processing has finished, in the order of input reads.", 0, "Input/Output options");
...
//int ProcessArgs2(int argc, char **argv, ProgramParameters *parameters)
//{
//  if (argc == 1) {
//    VerboseShortHelpAndExit(argc, argv);
//  }
...
//        parameters->output_multiple_alignments = true;
//        break;
//
//      case 'P':
