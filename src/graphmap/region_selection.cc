...
int GraphMap::RegionSelection_(int64_t bin_size, MappingData* mapping_data, const Index* index_primary, const Index* index_secondary, const SingleSequence* read, const ProgramParameters* parameters) {
